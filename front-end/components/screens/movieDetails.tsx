...
//   videoPlayer: { width: '100%', height: 250, borderRadius: 12, marginBottom: 20 },
//   metadataContainer: { marginBottom: 30 },
//   title: { fontSize: 28, fontWeight: 'bold', color: '#1a1a1a', marginBottom: 8 },
//   creatorContainer: { flexDirection: 'row', marginBottom: 12 },
//   creatorLabel: { color: '#6c757d', marginRight: 6 },
//   creatorName: { color: '#2c3e50', fontWeight: '500' },
//   detailRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 15 },
//   genre: { backgroundColor: '#e9ecef', paddingVertical: 4, paddingHorizontal: 12, borderRadius: 20, color: '#495057' },
//   year: { color: '#6c757d', fontSize: 16 },
//   description: { fontSize: 16, lineHeight: 24, color: '#4a4a4a' },
//   readMore: { color: '#007bff', fontWeight: '500' },
//   commentsSection: { borderTopWidth: 1, borderTopColor: '#e0e0e0', paddingTop: 20 },
//   sectionTitle: { fontSize: 20, fontWeight: '600', color: '#1a1a1a', marginBottom: 15 },
//   commentCard: { backgroundColor: 'white', borderRadius: 8, padding: 16, marginBottom: 12, elevation: 1, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2 },
//   commentUser: { fontWeight: '600', color: '#2c3e50', marginBottom: 4 },
//   commentText: { color: '#4a5568', lineHeight: 20 },
//   inputContainer: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: 'white', flexDirection: 'row', alignItems: 'center', padding: 12, borderTopWidth: 1, borderTopColor: '#e0e0e0' },
//   commentInput: { flex: 1, backgroundColor: '#f8f9fa', borderRadius: 25, paddingHorizontal: 18, paddingVertical: 12, marginRight: 12, fontSize: 16, maxHeight: 100 },
//   postButton: { backgroundColor: '#007bff', borderRadius: 25, paddingVertical: 12, paddingHorizontal: 20 },
//   postButtonText: { color: 'white', fontWeight: '500', fontSize: 16 },
// });
